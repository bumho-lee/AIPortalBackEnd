...
public class NeoSloWsImplServiceLocator extends org.apache.axis.client.Service implements hanwha.neo.branch.common.sso.service.NeoSloWsImplService {
    ...
    private java.lang.String NeoSloWsImplPort_address = "https://htg.circle.hanwha.com/api/ss/neoslo";
    ...
    public hanwha.neo.branch.common.sso.service.NeoSloWs getNeoSloWsImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public hanwha.neo.branch.common.sso.service.NeoSloWs getNeoSloWsImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub _stub = new hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (hanwha.neo.branch.common.sso.service.NeoSloWs.class.isAssignableFrom(serviceEndpointInterface)) {
                hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub _stub = new hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub(new java.net.URL(NeoSloWsImplPort_address), this);
                _stub.setPortName(getNeoSloWsImplPortWSDDServiceName());
                return _stub;
            }
        }
