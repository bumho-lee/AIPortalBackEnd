...
package esea.common.vo;

public class WsAttachFile  implements java.io.Serializable {
    private java.lang.String fileId;

    private jakarta.activation.DataHandler fileInfo;
    ...
    public WsAttachFile(
           ...
           jakarta.activation.DataHandler fileInfo,
     ...
     * @return fileInfo
     */
    public jakarta.activation.DataHandler getFileInfo() {
        return fileInfo;
    }
     ...
     * @param fileInfo
     */
    public void setFileInfo(jakarta.activation.DataHandler fileInfo) {
        this.fileInfo = fileInfo;
    }
