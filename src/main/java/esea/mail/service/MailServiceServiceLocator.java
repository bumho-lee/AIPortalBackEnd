...
public class MailServiceServiceLocator extends org.apache.axis.client.Service implements esea.mail.service.MailServiceService {
    ...
    private java.lang.String MailService_address = System.getenv("EAMAIL_ADDRESS") != null ? System.getenv("EAMAIL_ADDRESS") : "https://htg.circle.hanwha.com/api/axis/services/MailService";
    ...
    public esea.mail.service.MailService getMailService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	esea.mail.service.MailServiceSoapBindingStub _stub = new esea.mail.service.MailServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (esea.mail.service.MailService.class.isAssignableFrom(serviceEndpointInterface)) {
            	esea.mail.service.MailServiceSoapBindingStub _stub = new esea.mail.service.MailServiceSoapBindingStub(new java.net.URL(MailService_address), this);
                _stub.setPortName(getMailServiceWSDDServiceName());
                return _stub;
            }
        }
