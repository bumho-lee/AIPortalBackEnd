...
public class MailServiceSoapBindingStub extends org.apache.axis.client.Stub implements esea.mail.service.MailService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(esea.mail.vo.WsMailStatus[].class);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "senderInfo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vo.mail.ss.branch.neo.hanwha", "WsResource"), esea.mail.vo.WsResource.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "mailInfo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vo.mail.ss.branch.neo.hanwha", "WsMailInfo"), esea.mail.vo.WsMailInfo.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "receivers"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vo.mail.ss.branch.neo.hanwha", "WsRecipient"), esea.mail.vo.WsRecipient[].class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://service.mail.ss.branch.neo.hanwha", "attachFile"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vo.common.ss.branch.neo.hanwha", "WsAttachFile"), esea.common.vo.WsAttachFile[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
    ...
    public MailServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = esea.common.vo.WsAttachFile.class;
            ...
            cachedSerQNames.add(qName);
            cls = esea.common.vo.WsException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = esea.mail.vo.WsMailInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = esea.mail.vo.WsMailStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = esea.mail.vo.WsRecipient.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = esea.mail.vo.WsResource.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mailKey});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (esea.mail.vo.WsMailStatus[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (esea.mail.vo.WsMailStatus[]) org.apache.axis.utils.JavaUtils.convert(_resp, esea.mail.vo.WsMailStatus[].class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof esea.common.vo.WsException) {
              throw (esea.common.vo.WsException) axisFaultException.detail;
         }
   }
